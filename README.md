...
**🔄 Руководитель группы аналитики → AI Technical / Product Manager**

Более 9 лет в IT: аналитика, управление проектами, управление отделом системного анализа.
В настоящее время развиваю экспертизу в области AI/LLM-инженерии — владею полным циклом: от построения агентских архитектур до метрик и валидации RAG-систем.
...
| Область | Уровень |
|---|---|
| 🐍 Python (LangChain, FastAPI, Pydantic) | Активно развиваю |
...
| 🐳 Docker, GitHub Actions, CI/CD | Использую в проекте |
| 👥 Управление командами | 5 лет опыта |
